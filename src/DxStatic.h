...
extern	int			NS_DrawCircleAA(     float x,  float y,  float r,            int posnum,                             unsigned int Color, int FillFlag = TRUE, float LineThickness = 1, float Angle = 0.0 ) ;	// 円を描画する( アンチエイリアス付き )
