...
>>>>>>> d570d3a ([Bot] Update iOS Part before 3.24d)
	...
	{ HTML5_RENDER_TYPE_NORMAL,		TRUE,  GL_SRC_ALPHA,			GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				GL_ONE,					GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_NORMAL	Spine のブレンドモード Normal 用
	{ HTML5_RENDER_TYPE_NORMAL,		TRUE,  GL_SRC_ALPHA,			GL_ONE,					GL_FUNC_ADD,				GL_ONE,					GL_ONE,					GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_ADDITIVE	Spine のブレンドモード Additive 
	{ HTML5_RENDER_TYPE_NORMAL,		TRUE,  GL_DST_COLOR,			GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				GL_ONE_MINUS_SRC_ALPHA,	GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_MULTIPLY	Spine のブレンドモード Multiply 
...
const GLchar *g_UniformName[ HTML5_SHADER_UNIFORM_NUM ] =
{
	...
	"uAddColor",					// HTML5_SHADER_UNIFORM_ADD_COLOR
...
)
{
	...
	// StretchRect用の設定を行う
	{
		...
		Graphics_HTML5_DeviceState_SetBlendMode( AlphaBlend ? DX_BLENDMODE_ALPHA : DX_BLENDMODE_NOBLEND, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, FALSE ) ;
...
//		) ;
		...
		// ブレンドモード設定
		Graphics_HTML5_DeviceState_SetBlendMode( DX_BLENDMODE_NOBLEND, FALSE, DX_BLEND_ZERO, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ZERO, DX_BLEND_ZERO, DX_BLENDOP_ADD, FALSE ) ;
...
extern	int		Graphics_HTML5_Device_ReInitialize( void )
{
	...
	// 削除前と同じ環境を作り出す
	{
		...
		// 描画ブレンドモードの設定
		Graphics_HTML5_DrawSetting_SetDrawBlendMode(
			GHTML5.Device.DrawSetting.BlendMode,
			GHTML5.Device.DrawSetting.BlendEnable,
			GHTML5.Device.DrawSetting.BlendRGBSrc,
			GHTML5.Device.DrawSetting.BlendRGBDest,
			GHTML5.Device.DrawSetting.BlendRGBOp,
			GHTML5.Device.DrawSetting.BlendASrc,
			GHTML5.Device.DrawSetting.BlendADest,
			GHTML5.Device.DrawSetting.BlendAOp,
			GHTML5.Device.DrawSetting.AlphaTestValidFlag,
			GHTML5.Device.DrawSetting.AlphaChannelValidFlag
		) ;
...
// 描画ブレンドモードのセット
extern	int		Graphics_HTML5_DeviceState_SetBlendMode( int BlendMode, int BlendEnable, int BlendRGBSrc, int BlendRGBDest, int BlendRGBOp, int BlendASrc, int BlendADest, int BlendAOp, int NotWriteAlphaChannelFlag )
{
	...
	if( GHTML5.Device.State.BlendMode		== BlendMode &&
		GHTML5.Device.State.BlendEnable	== BlendEnable &&
		GHTML5.Device.State.BlendRGBSrc	== BlendRGBSrc &&
		GHTML5.Device.State.BlendRGBDest	== BlendRGBDest &&
		GHTML5.Device.State.BlendRGBOp	== BlendRGBOp &&
		GHTML5.Device.State.BlendASrc		== BlendASrc &&
		GHTML5.Device.State.BlendADest	== BlendADest &&
		GHTML5.Device.State.BlendAOp		== BlendAOp &&
...
extern int Graphics_HTML5_DeviceState_UpdateShaderUniform( GRAPHICS_HTML5_SHADER *Shader, int LightNum, int UseLocalWorldMatrixUniformNum )
{
	...
	if( Shader->UniformIndex[ HTML5_SHADER_UNIFORM_ADD_COLOR ] != 0xffff )
	{
		UNIFORM_SET_FLOAT4( Shader->UniformIndex[ HTML5_SHADER_UNIFORM_ADD_COLOR ], GHTML5.Device.Shader.Constant.uAddColor ) ;
	}
...
extern	int		Graphics_HTML5_DeviceState_NormalDrawSetup( void )
{
	...
	{
		NextBlendMode		= GHTML5.Device.DrawSetting.BlendMode ;
		NextBlendEnable		= GHTML5.Device.DrawSetting.BlendEnable ;
		NextBlendRGBSrc		= GHTML5.Device.DrawSetting.BlendRGBSrc ;
		NextBlendRGBDest	= GHTML5.Device.DrawSetting.BlendRGBDest ;
		NextBlendRGBOp		= GHTML5.Device.DrawSetting.BlendRGBOp ;
		NextBlendASrc		= GHTML5.Device.DrawSetting.BlendASrc ;
		NextBlendADest		= GHTML5.Device.DrawSetting.BlendADest ;
		NextBlendAOp		= GHTML5.Device.DrawSetting.BlendAOp ;
		switch( GHTML5.Device.DrawSetting.BlendMode )
		{
		case DX_BLENDMODE_SUB :
			// 減算ブレンドの場合は14番目のブレンドモードを使用する
	...
	Graphics_HTML5_DeviceState_SetBlendMode(
		...
		NextBlendADest,
		NextBlendAOp,
		GHTML5.Device.DrawSetting.NotWriteAlphaChannelFlag
	) ;
...
// 描画ブレンドモードの設定
extern int Graphics_HTML5_DrawSetting_SetDrawBlendMode( int BlendMode, int BlendEnable, int BlendRGBSrc, int BlendRGBDest, int BlendRGBOp, int BlendASrc, int BlendADest, int BlendAOp, int AlphaTestValidFlag, int AlphaChannelValidFlag )
{
	if( GHTML5.Device.DrawSetting.CancelSettingEqualCheck == FALSE &&
		GHTML5.Device.DrawSetting.BlendMode               == BlendMode &&
		GHTML5.Device.DrawSetting.BlendEnable				== BlendEnable  &&
		GHTML5.Device.DrawSetting.BlendRGBSrc				== BlendRGBSrc  &&
		GHTML5.Device.DrawSetting.BlendRGBDest			== BlendRGBDest &&
		GHTML5.Device.DrawSetting.BlendRGBOp				== BlendRGBOp   &&
		GHTML5.Device.DrawSetting.BlendASrc				== BlendASrc    &&
		GHTML5.Device.DrawSetting.BlendADest				== BlendADest   &&
		GHTML5.Device.DrawSetting.BlendAOp				== BlendAOp     &&
...
//	Graphics_DrawSetting_SetUse2DProjectionMatrix( ( ParamFlag & DX_HTML5_DRAWPREP_3D ) == 0 ? TRUE : FALSE ) ;
	...
	if( ( ParamFlag & DX_HTML5_DRAWPREP_NOBLENDSETTING ) == 0 )
	{
		...
		if( GHTML5.Device.DrawSetting.BlendMode             != GSYS.DrawSetting.BlendMode ||
			GHTML5.Device.DrawSetting.BlendEnable           != GSYS.DrawSetting.BlendEnable  ||
			GHTML5.Device.DrawSetting.BlendRGBSrc           != GSYS.DrawSetting.BlendRGBSrc  ||
			GHTML5.Device.DrawSetting.BlendRGBDest          != GSYS.DrawSetting.BlendRGBDest ||
			GHTML5.Device.DrawSetting.BlendRGBOp            != GSYS.DrawSetting.BlendRGBOp   ||
			GHTML5.Device.DrawSetting.BlendASrc             != GSYS.DrawSetting.BlendASrc    ||
			GHTML5.Device.DrawSetting.BlendADest            != GSYS.DrawSetting.BlendADest   ||
			GHTML5.Device.DrawSetting.BlendAOp              != GSYS.DrawSetting.BlendAOp     ||
