...
extern int Live2DCubism4_SetupShader_PF( int ConstantBufferHandle, D_CubismConstantBufferDxLib *ConstantBuffer, D_ShaderNames VertexShader, D_ShaderNames PixelShader )
{
	...
	GLuint u_multiplyColor = Graphics_HTML5_Shader_GetUniformIndex( &LIVE2DSYS.PF.Shader[ index ], "u_multiplyColor" ) ;
	GLuint u_screenColor   = Graphics_HTML5_Shader_GetUniformIndex( &LIVE2DSYS.PF.Shader[ index ], "u_screenColor" ) ;
